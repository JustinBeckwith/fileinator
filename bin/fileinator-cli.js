...
yargs(hideBin(process.argv))
  ...
  .example(
    '$0 make 2mb ./bigfile',
    'Create a 2MB file named `bigfile` in the current directory.',
  )
  .command('make <size> <path>', 'Make a big file', {}, (argv) => {
    console.log(
      `you want me to make a file that named ${argv.path} that's ${argv.size}`,
    );
